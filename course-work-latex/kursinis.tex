...
Vienų metų bus įvedami nauji duomenys ir tuo pačiu metu tam tikrais laiko intervlais kviečiama procedūra ir bus tikrinima:
    \begin{enumerate}
        ...
        \item Kiek sekundžių suletėja procedūra, kai yra pastoviai dedami duomenys.
    \end{enumerate}
...
Prieš pradedant eksperimenta išmatuota, kad ,,GetReports" procedūra, neapkrovus duomenų bazės jokiais kitais veiksmais, ir per kiek laiko užtrunka visų duomenų įdėjimas,
...
\item Paleidžiama programa kviečianti procedūra ,,GetReports" ir nustatyta, kad ji procedūrą kviestų kas 5 sekundes norint simuliuoti realią apkrova, po kiekvieno kvietimo ji fiksuoja kiek laiko 
užtrūko ir kelinta karta ji yra kviečiama. 
...
Prieš pradedant testavimą į sistemą buvo sugeneruota 10,000,000 įrašų, kad būtų sudarytos sąlygos panašios kaip ir reliacinės duomenų bazės.
...
\begin{table}[!htbp]
    \begin{center}
        ...
        \begin{tabular}{ | l | p{4cm} | p{3cm} | } 
            ...
            Pralaidumas (duomenų kiekis per sekundę) & \textasciitilde 4,200 & \textasciitilde 5,475 \\* \hline
...
Taip pat vienas iš procedūros trūkumų - įdėjus bent vieną nauja duomenį ir norint gauti ataskaita turi iš naujo būti vykdoma procedūra, kurios trukmė, kai nėra 

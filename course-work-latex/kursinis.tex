...
% Apibrėžime minėjau, kad rodiklių duomenis yra didelių duomenų tipas, 
...
% gauti tik įdėjus naujus duomenis.
...
%  Kadangi bendravimas tarp programos ir žinučių sistemos yra greitas, testavimui įvestas kintamasis, kuris
...
% nurodo kokiam laiko tarpui sustabdomas einamasis procesas. Derinant šį uždelsimo laiką bus įmanoma nustatyti ir palygint abiejų sprendimų pralaidumus. 
% Tačiau, kadangi ,,sleep'' funkcija naudoja procesoriaus dažnį, ji nėra absoliučiai tiksli
...
% su kurios buvo vykdomi testai, paklaida, kuri buvo 0.86 milisekundės. \par

...
2005 metais Michael Stonebraker apibrėžė 8 taisyklės realaus-laiko(angl. real-time) srautinio duomenų apdorojimo architektūroms\cite{stonebraker20058}:
...
Testavimo duomenų generavimo sistema yra sudaryta iš dviejų dalių: ,,Python" kalba parašytas duomenų generatorius ir siuntėjas į žinučių sistemą ir
...
\begin{table}[!htbp]
    \begin{center}
        ...
        \begin{tabular}{ | l | p{4cm} | p{3cm} | } 
            ...
            Vienos duomens apdorojimas ir agregavimas & \textasciitilde75 milisekundės & \textasciitilde12 sekundžių \\* \hline
        \end{tabular}
    \end{center}
\end{table}\par
...
\vspace{1 mm}
    ...
    \begin{enumerate}
        \item Sukurtas testavimo duomenų generatorius, sukurtas supaprastinto uždavinio sprendimas su reliacine duomenų baze ir su srautinio apdorojimo architektūra.
...
\vspace{1 mm}
    ...
    (\textasciitilde75 milisekundės naujo duomens apdorojimui ir agregavimui į esamą sąrašą) nei reliacinių duomenų

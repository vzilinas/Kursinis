...
from heronpy.api.api_constants import constants
...
if __name__ == '__main__':
    ...
    price_calculation_bolt = builder.add_bolt("price_calculation_bolt", PriceCalculationBolt, par=2,
    ...
    # and
    report_aggregation_bolt = builder.add_bolt("report_aggregation_bolt", ReportAggregationBolt, par=2,
